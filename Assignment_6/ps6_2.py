...
def is_valid_word(word, hand, word_list):
    ...
    return matchHand and word in word_list
    ...
    * The final score is displayed.
    ...
    while len(hand) > 0 and word != '.':
        ...
        while not validWord:
            ...
            timeLeft = round(timeLeft - answerTime,2)
            ...
            if word == '.':
                ...
                currentScore = round(currentScore/answerTime,2)
                totalScore += currentScore
                print "'%s' is worth %0.2f points" %(word, currentScore)
                print 'Round score so far = ', totalScore
                print 'You took ', round(answerTime,2), ' to answer.'
                print 'You have ', timeLeft, ' seconds left on timer'
