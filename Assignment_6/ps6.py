    ...
    while hand > 0 and word != '.':
        ...
        while not validWord:
            ...
            if word == '.':
                ...
                currentScore = round(currentScore/(endTime - startTime),2)
                totalScore += currentScore
                print 'You took ', endTime - startTime, ' to answer.'
                print "'", word, "' is worth ", currentScore, ' points'
